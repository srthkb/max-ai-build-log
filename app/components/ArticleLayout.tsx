...
export default function ArticleLayout({ eyebrow, title, lead, visualLabel, children, summary, relatedLabel, relatedHref, visualTheme = "default", visual, showTopBack = true, ending }: ArticleLayoutProps) {
